...
const buttonVariants = cva(
  "relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full md-label-large transition-all duration-200 select-none disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-[18px] shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        // M3 roles
        filled:
          "bg-primary text-on-primary md-elevation-0 hover:md-elevation-1 state-layer-on-primary",
        tonal:
          "bg-secondary-container text-on-secondary-container state-layer-on-secondary-container",
        elevated:
          "bg-surface-container-low text-primary md-elevation-1 hover:md-elevation-2 state-layer-primary",
        outlined:
        ...
        destructive:
          "bg-destructive text-on-error md-elevation-0 hover:md-elevation-1 state-layer-on-error focus-visible:ring-destructive/20",
